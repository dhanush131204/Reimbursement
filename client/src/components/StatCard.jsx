const StatCard = ({ icon: Icon, label, value, iconClassName = 'bg-[#dbeafe] text-[#1264d8]', className = '', dense = false }) => (
  <div className={`flex h-full flex-col justify-between rounded-lg border bg-white p-5 ${dense ? 'min-h-[118px] border-[#cbd7e1]' : 'min-h-[150px] border-[#d7e0e8] shadow-sm'} ${className}`}>
